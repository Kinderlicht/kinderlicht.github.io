export default function Home() {
  return (
    <section className="bg-white dark:bg-gray-900">
      <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Datenschutz</h2>

      <h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white"><strong>Website / Datenschutzerklärung / Privacy Policy</strong></h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        Der Kinderlicht Wallersdorf e. V. nimmt als Anbieter der Website <a href="http://www.kinderlicht-wallersdorf.de" target="_blank" rel="noopener noreferrer">www.kinderlicht-wallersdorf.de</a> und verantwortliche Stelle die Verpflichtung zum Datenschutz sehr ernst und gestaltet seine Website so, dass nur so wenige personenbezogene Daten wie nötig erhoben, verarbeitet und genutzt werden. Unter keinen Umständen werden personenbezogene Daten zu Werbezwecken an Dritte vermietet oder verkauft. Ohne die ausdrückliche Einwilligung des Besuchers werden keine personenbezogenen Daten für Werbe- oder Marketingzwecke genutzt.

        Zugriff auf personenbezogene Daten haben beim Kinderlicht Wallersdorf e. V. nur solche Personen, die diese Daten zur Durchführung ihrer Aufgaben innerhalb der verantwortlichen Stelle benötigen, die über die gesetzlichen Bestimmungen zum Datenschutz informiert sind und sich gemäß der geltenden gesetzlichen Bestimmungen (§ 5 Bundesdatenschutzgesetzes [BDSG], bzw. Art. 5 der EU-Datenschutzgrundverordnung [EU-DSGVO]) verpflichtet haben, diese einzuhalten. Die Erhebung, Verarbeitung, Nutzung und Übermittlung der erhobenen personenbezogenen Daten erfolgt nach § 28 Abs. 1 und Abs. 3 BDSG, bzw., ab dem 25.05.2018, Art. 6. Abs. 1 EU-DSGVO, jeweils nur in dem Umfang, der für die Durchführung eines Vertragsverhältnisses zwischen dem Kinderlicht Wallersdorf e. V., als verantwortlicher Stelle, und dem Besucher, als Betroffenem, erforderlich ist.
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Zweckänderungen der Verarbeitung und Datennutzung</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        Da sich aufgrund des technischen Fortschritts und organisatorischer Änderungen die eingesetzten Verarbeitungsverfahren ändern/weiterentwickeln können, behalten wir uns vor, die vorliegende Datenschutzerklärung gemäß den neuen technischen Rahmenbedingungen weiterzuentwickeln. Wir bitten Sie deshalb, die Datenschutzerklärung von&nbsp;<a href="http://www.kinderlicht-wallersdorf.de/" target="_blank" rel="noopener noreferrer"> www.kinderlicht-wallersdorf.de</a> von Zeit zu Zeit zu überprüfen. Sollten Sie mit den im Verlaufe der Zeit auftretenden Weiterentwicklungen nicht einverstanden sein, so können Sie schriftlich, gemäß
      ...
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Anonyme Datenerhebung</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
      ...
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Export und Verarbeitung der Daten in Staaten außerhalb des Europäischen Wirtschaftsraumes</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        ...
        Trotzdem können, soweit Sie sich in Facebook eingeloggt haben oder einen Twitter-Account oder einen Instagram-Account besitzen, personenbezogene Daten in die USA exportiert werden. Zu näheren Erläuterungen und zu Möglichkeiten, diesen Datenexport zu verhindern, lesen Sie bitte den Gliederungspunkt „Verwendung von Facebook Social Plugins“ bzw. „Verwendung von Twitter“ bzw. „Verwendung von Instagram Social Plugins“ der vorliegenden Datenschutzerklärung.
      ...
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Externe Links</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
      ...
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Einsatz von Cookies</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
      ...
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Sitzungscookies</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
      ...
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Permanente Cookies</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
      ...
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Vermeidung von Cookies</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
      ...
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Verwendung von Analyseprogrammen</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        Die verantwortliche Stelle führt Analysen über das Verhalten seiner Kunden im Rahmen der Nutzung seines Services durch bzw. lässt diese durchführen. Zu diesem Zweck werden anonymisierte oder pseudonymisierte Nutzungsprofile erstellt. Die Erstellung der Nutzungsprofile erfolgt zu dem alleinigen Zweck, den Service der verantwortlichen Stelle ständig zu verbessern.

        Die verantwortliche Stelle verwendet im Rahmen der Web-Analyse auch Google Analytics, einen Web-Analysedienst der Google Inc. ("Google"), den die verantwortliche Stelle Google Analytics mit der Erweiterung „_anonymizeIp()“ nutzt. Dadurch werden die IP-Adressen nur gekürzt verarbeitet, um eine direkte Personenbeziehbarkeit auszuschließen. Der in diesem Zusammenhang stattfindenden Datenerhebung und -speicherung kann jederzeit mit Wirkung für die Zukunft widersprochen werden. Bitte wenden Sie sich dazu <a href="http://tools.google.com/dlpage/gaoptout?hl=de" target="_blank" rel="noopener noreferrer">direkt an Google. </a>

        Google gibt seinen Nutzern, wie beispielsweise der verantwortlichen Stelle vor, die nachfolgende Belehrung in ihren Datenschutzerklärungen zu verwenden. Dieser Aufforderung kommt der&nbsp;Kinderlicht Wallersdorf e. V. &nbsp;mit der Wiedergabe des folgenden Textes nach:

        <em>“Google Analytics verwendet sog. „Cookies“, Textdateien, die auf Ihrem Computer gespeichert werden und die eine Analyse der Benutzung der Website durch Sie ermöglichen. Die durch den Cookie erzeugten Informationen über Ihre Benutzung dieser Website (einschließlich Ihrer IP-Adresse) werden an einen Server von Google in den USA übertragen und dort gespeichert. Google wird diese Informationen benutzen, um Ihre Nutzung der Website auszuwerten, um Reports über die Websiteaktivitäten für die Websitebetreiber zusammenzustellen und um weitere mit der Websitenutzung und der Internetnutzung verbundene Dienstleistungen zu erbringen. Auch wird Google diese Informationen gegebenenfalls an Dritte übertragen, sofern dies gesetzlich vorgeschrieben oder soweit Dritte diese Daten im Auftrag von Google verarbeiten. Google wird in keinem Fall Ihre IP-Adresse mit anderen Daten von Google in Verbindung bringen. Sie können die Installation der Cookies durch eine entsprechende Einstellung Ihrer Browser Software verhindern; wir weisen Sie jedoch darauf hin, dass Sie in diesem Fall gegebenenfalls nicht sämtliche Funktionen dieser Website vollumfänglich nutzen können. Durch die Nutzung dieser Website erklären Sie sich mit der Bearbeitung der über Sie erhobenen Daten durch Google in der zuvor beschriebenen Art und Weise und zu dem zuvor benannten Zweck einverstanden.”</em>
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Verwendung von Facebook Social Plugins</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
      ...
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Verwendung von Twitter</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        ...
        Wir weisen darauf hin, dass wir als Anbieter der Seiten keine Kenntnis vom Inhalt der übermittelten Daten sowie deren Nutzung durch Twitter erhalten. Weitere Informationen hierzu finden Sie in der Datenschutzerklärung von Twitter unter: <a href="http://www.twitter.com/privacy" target="_blank" rel="noopener noreferrer">www.twitter.com/privacy</a>
        Ihre Datenschutzeinstellungen bei Twitter können Sie in den Konto-Einstellungen ändern unter:

        <a href="http://www.twitter.com/account/settings" target="_blank" rel="noopener noreferrer">www.twitter.com/account/settings</a>.
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Verwendung von Instagram Social Plugins</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        ...
        <a href="http://blog.instagram.com/post/36222022872/introducing-instagram-badges" target="_blank" rel="noopener noreferrer">http://blog.instagram.com/post/36222022872/introducing-instagram-badges</a>.
        ...
        Zweck und Umfang der Datenerhebung und die weitere Verarbeitung und Nutzung der Daten durch Instagram sowie Ihre diesbezüglichen Rechte und Einstellungsmöglichkeiten zum Schutz Ihrer Privatsphäre entnehmen Sie bitte den Datenschutzhinweisen von Instagram: <a href="https://help.instagram.com/155833707900388/" target="_blank" rel="noopener noreferrer">https://help.instagram.com/155833707900388/</a>.

        Wenn Sie nicht möchten, dass Instagram die über unseren Webauftritt gesammelten Daten unmittelbar Ihrem Instagram-Account zuordnet, müssen Sie sich vor Ihrem Besuch unserer Website bei Instagram ausloggen. Sie können das Laden der Instagram Plugins auch mit Add-Ons für Ihren Browser komplett verhindern, z.B. mit dem Skript-Blocker „NoScript“ (<a href="http://noscript.net/" target="_blank" rel="noopener noreferrer">http://noscript.net/</a>).
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Verwendung von YouTube-Plugins</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        ...
        Weitere Informationen zur Datenverarbeitung und Hinweise zum Datenschutz durch YouTube (Google) finden Sie unter <a href="http://www.google.de/intl/de/policies/privacy/" target="_blank" rel="noopener noreferrer">www.google.de/intl/de/policies/privacy/</a>.
      </p><h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">Weitere Informationen und Kontakte</h3><p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        Wenn Sie weitere Fragen zum Thema "Datenschutz bei der verantwortlichen Stelle" haben, wenden Sie sich an den Datenschutzbeauftragten des Kinderlicht Wallersdorf e. V. Sie können erfragen, welche Ihrer Daten bei uns gespeichert sind.
        Darüber hinaus können Sie Auskünfte, Löschungs- und Berichtigungswünsche zu Ihren Daten und gerne auch Anregungen jederzeit per Brief oder E-Mail an die Adresse unten im Impressum senden.
      </p>
      <div className="w-full grid place-items-center">
        <div className="w-fit p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">

          <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Impressum</h5>

          <div className="mb-3 flex flex-row font-normal text-gray-500 dark:text-gray-400" id="impressum">
            <div className="xl:w-1/2 md:w-1/2 p-4">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="inline-block bi bi-phone" viewBox="0 0 16 16">
                <path d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h6zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H5z" />
                <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" />
              </svg>  (09933)&nbsp;6289907<br></br>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="inline-block bi bi-envelope" viewBox="0 0 16 16">
                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z" />
              </svg>  info[at]kinderlicht-wallersdorf.de
            </div>
            <div className="xl:w-1/2 md:w-1/2 p-4">
              ...
              108/109/50221<br></br>
              <i>gemäß §27a Umsatzsteuergesetz</i><br></br>
            </div>
          </div>

          <i className="text-gray-500">Angaben gemäß § 5 TMG; vertreten durch Enrico Koch und Christina Weig</i>
        </div>
      </div>
    </section>
  );
