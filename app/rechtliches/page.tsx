  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      ...
      <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        ...
        und verantwortliche Stelle die Verpflichtung zum Datenschutz sehr ernst
        und gestaltet seine Website so, dass nur so wenige personenbezogene
        Daten wie nötig erhoben, verarbeitet und genutzt werden. Unter keinen
        Umständen werden personenbezogene Daten zu Werbezwecken an Dritte
        vermietet oder verkauft. Ohne die ausdrückliche Einwilligung des
        Besuchers werden keine personenbezogenen Daten für Werbe- oder
        Marketingzwecke genutzt. Zugriff auf personenbezogene Daten haben beim
        Kinderlicht Wallersdorf e. V. nur solche Personen, die diese Daten zur
        ...
        informiert sind und sich gemäß der geltenden gesetzlichen Bestimmungen
        (§ 5 Bundesdatenschutzgesetzes [BDSG], bzw. Art. 5 der
        EU-Datenschutzgrundverordnung [EU-DSGVO]) verpflichtet haben, diese
        einzuhalten. Die Erhebung, Verarbeitung, Nutzung und Übermittlung der
        erhobenen personenbezogenen Daten erfolgt nach § 28 Abs. 1 und Abs. 3
        BDSG, bzw., ab dem 25.05.2018, Art. 6. Abs. 1 EU-DSGVO, jeweils nur in
        dem Umfang, der für die Durchführung eines Vertragsverhältnisses
        zwischen dem Kinderlicht Wallersdorf e. V., als verantwortlicher Stelle,
      ...
      <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        ...
        schriftlich, gemäß Art. 17 EU-DSGVO, eine Löschung der Daten, die nicht
        auf Grundlage anderer gesetzlicher Vorgaben, wie handelsrechtlicher oder
      ...
      <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        ...
        besuchen, ohne uns mitzuteilen, wer Sie sind. Wir erfahren nur den Namen
        Ihres Internet Service Providers, die Webseite, von der aus Sie uns
      ...
      <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        ...
        elektronischen Dienste verarbeitet. Sie haben jederzeit die Möglichkeit,
        der Speicherung ihrer personenbezogenen Daten zu widersprechen. Bitte
        ...
        und Nutzung Ihrer personenbezogenen Daten erfolgt nach den Vorgaben des
        BDSG bzw., ab 25.05.2018, der EU-DSGVO.
      </p>
      <h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">
        Export und Verarbeitung der Daten in Staaten außerhalb des Europäischen
        Wirtschaftsraumes
      </h3>
      <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        Es findet kein Export ihrer personenbezogenen Daten in Staaten außerhalb
        des Europäischen Wirtschaftsraumes (im Folgenden EWR) statt. Trotzdem
        können, soweit Sie sich in Facebook eingeloggt haben oder einen
        ...
        Dienstleistern bestehen Verträge, die den Datenschutz- und
        Datensicherheits-Vorgaben der Europäischen Datenschutzrichtlinie
        (95/46/EG) und des deutschen Datenschutzrechts, bzw., ab dem 25.05.2018,
        der EU-DSGVO entsprechen. Auch im Falle der Einschaltung von externen
        Dienstleistern bleibt der Kinderlicht Wallersdorf e. V.&nbsp; die für
      ...
      <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        Zu Ihrer Information finden Sie auf unseren Seiten Links, die auf Seiten
        Dritter verweisen. Soweit dies nicht offensichtlich erkennbar ist,
        weisen wir Sie darauf hin, dass es sich um einen externen Link handelt.
        Die verantwortliche Stelle hat keinerlei Einfluss auf den Inhalt und die
      ...
      <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        ...
        verantwortlichen Stelle seine persönlichen Einstellungen wieder
        vorfindet. Daneben verwenden die Dienstleister, die die verantwortliche
        Stelle mit der Analyse des Nutzerverhaltens beauftragt hat, permanente
        Cookies, um wiederkehrende Nutzer erkennen zu können. Diese Dienste
        speichern die vom Cookie übermittelten Daten ausschließlich anonym ab.
      ...
      <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        ...
        mindern und sich bei der Nutzung der Dienste der verantwortlichen Stelle
      ...
      <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        ...
        durchführen. Zu diesem Zweck werden anonymisierte oder pseudonymisierte
        Nutzungsprofile erstellt. Die Erstellung der Nutzungsprofile erfolgt zu
      ...
      <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        ...
        Einstellungsmöglichkeiten des Kunden zum Schutz seiner Privatsphäre ist
        den Datenschutzhinweisen von Facebook zu entnehmen. Sollte der Kunde
        nicht wollen, dass Facebook in der vorbeschriebenen Weise Daten sammelt,
        muss der Kunde sich vor seinem Besuch des Internetauftritts der
        verantwortlichen Stelle bei Facebook ausloggen.
      </p>
      <h3 className="mb-4 text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">
      ...
      <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
        Die verantwortliche Stelle nutzt für die Einbindung von Videos u.a. den
        Anbieter YouTube. YouTube wird betrieben von YouTube LLC mit
        ...
        unsere mit einem YouTube Plugin versehene Internetpräsenz aufrufen, wird
        eine Verbindung zu den Servern von YouTube hergestellt. Hierdurch wird
        an den YouTube-Server übermittelt, welche Internetseiten Sie besucht
