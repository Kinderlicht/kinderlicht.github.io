    ...
    <div className="px-0.5">
      <section className="bg-white dark:bg-gray-900">
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          Werbezwecken an Dritte vermietet oder verkauft. Ohne die ausdrückliche
          Einwilligung des Besuchers werden keine personenbezogenen Daten für
          Werbe- oder Marketingzwecke genutzt. Zugriff auf personenbezogene
          Daten haben beim Kinderlicht Wallersdorf e. V. nur solche Personen,
          die diese Daten zur Durchführung ihrer Aufgaben innerhalb der
          verantwortlichen Stelle benötigen, die über die gesetzlichen
          Bestimmungen zum Datenschutz informiert sind und sich gemäß der
          geltenden gesetzlichen Bestimmungen (§ 5 Bundesdatenschutzgesetzes
          [BDSG], bzw. Art. 5 der EU-Datenschutzgrundverordnung [EU-DSGVO])
          verpflichtet haben, diese einzuhalten. Die Erhebung, Verarbeitung,
          Nutzung und Übermittlung der erhobenen personenbezogenen Daten erfolgt
          nach § 28 Abs. 1 und Abs. 3 BDSG, bzw., ab dem 25.05.2018, Art. 6.
          Abs. 1 EU-DSGVO, jeweils nur in dem Umfang, der für die Durchführung
          eines Vertragsverhältnisses zwischen dem Kinderlicht Wallersdorf e.
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          ändern/weiterentwickeln können, behalten wir uns vor, die vorliegende
          Datenschutzerklärung gemäß den neuen technischen Rahmenbedingungen
          weiterzuentwickeln. Wir bitten Sie deshalb, die Datenschutzerklärung
          von&nbsp;
          <a
            href="http://www.kinderlicht-wallersdorf.de/"
            target="_blank"
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          Namen Ihres Internet Service Providers, die Webseite, von der aus Sie
          uns besuchen, und die Webseiten, die Sie bei uns besuchen. Diese
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          aus, zum Beispiel zum Zwecke der Durchführung eines
          Vertragsverhältnisses zwischen dem Kinderlicht Wallersdorf e. V., als
          verantwortlicher Stelle, und dem Besucher, als Betroffenem, mitteilen.
          Die verantwortliche Stelle hält sich dabei an die Vorgaben der Art. 5
          und 6 EU-DSGVO. Im Rahmen der personalisierten Dienste der
          verantwortlichen Stelle werden Ihre Registrierungsdaten unter der
          Voraussetzung Ihrer Einwilligung zum Zwecke der Zusendung unseres
          Newsletters bzw. zur bedarfsgerechten Gestaltung der angebotenen
          elektronischen Dienste verarbeitet. Sie haben jederzeit die
          Möglichkeit, der Speicherung ihrer personenbezogenen Daten zu
          ...
          mit dem Betreff &quot;Datenbestände austragen&quot;. Die Verarbeitung
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          außerhalb des Europäischen Wirtschaftsraumes (im Folgenden EWR) statt.
          Trotzdem können, soweit Sie sich in Facebook eingeloggt haben oder
          einen Twitter-Account oder einen Instagram-Account besitzen,
          ...
          lesen Sie bitte den Gliederungspunkt &quot;Verwendung von Facebook
          Social Plugins&quot; bzw. &quot;Verwendung von Twitter&quot; bzw.
          &quot;Verwendung von Instagram Social Plugins&quot; der vorliegenden
          Datenschutzerklärung. Eine Übermittlung von personenbezogenen Daten an
          Google im Rahmen der Nutzung von Analyseprogrammen durch die
          verantwortliche Stelle findet hingegen nicht statt, da Ihre IP-Adresse
          nur anonymisiert übermittelt wird. Lesen Sie dazu bitte den Punkt
          &quot;Verwendung von Analyseprogrammen&quot; der vorliegenden
          Datenschutzerklärung. Soweit Sie sich bei Google eingeloggt haben oder
          einen Youtube-Account besitzen, können personenbezogene Daten in die
          USA exportiert werden. Zu näheren Erläuterungen und zu Möglichkeiten,
          diesen Datenexport zu verhindern, beachten Sie bitte den
          Gliederungspunkt &quot;Verwendung von YouTube-Plugins&quot;. Die von
          der verantwortlichen Stelle eingeschalteten Dienstleister haben ihren
          Sitz und betreiben ihre IT-Infrastruktur ausschließlich innerhalb des
          EWR. Dies gilt auch für eine eventuelle Nutzung von Cloud-basierenden
          Diensten. Mit den Dienstleistern bestehen Verträge, die den
          Datenschutz- und Datensicherheits-Vorgaben der Europäischen
          Datenschutzrichtlinie (95/46/EG) und des deutschen Datenschutzrechts,
          bzw., ab dem 25.05.2018, der EU-DSGVO entsprechen. Auch im Falle der
          Einschaltung von externen Dienstleistern bleibt der Kinderlicht
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          Marktforschung der verantwortlichen Stelle nur, wenn Sie hierzu zuvor
          Ihre Einwilligung erteilt haben. Im Übrigen findet keine Weitergabe an
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          Viren auf Ihren Computer zu laden. Hauptzweck von Cookies ist
          vielmehr, ein speziell auf den Kunden zugeschnittenes Angebot
          bereitzustellen und die Nutzung des Service so komfortabel wie möglich
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          sichergestellt, dass der Kunde bei einem erneuten Besuch der Webseiten
          der verantwortlichen Stelle seine persönlichen Einstellungen wieder
          vorfindet. Daneben verwenden die Dienstleister, die die
          verantwortliche Stelle mit der Analyse des Nutzerverhaltens beauftragt
          hat, permanente Cookies, um wiederkehrende Nutzer erkennen zu können.
          Diese Dienste speichern die vom Cookie übermittelten Daten
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          zusätzliche Programme. Näheres ist der Hilfe-Funktion des kundenseitig
          verwendeten Browsers zu entnehmen. Entscheidet sich der Kunde für die
          Ausschaltung von Cookies, kann dies den Leistungsumfang des Services
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          einen Web-Analysedienst der Google Inc. (&quot;Google&quot;), den die
          verantwortliche Stelle Google Analytics mit der Erweiterung
          ...
          Stelle vor, die nachfolgende Belehrung in ihren Datenschutzerklärungen
          zu verwenden. Dieser Aufforderung kommt der&nbsp;Kinderlicht
          Wallersdorf e. V. &nbsp;mit der Wiedergabe des folgenden Textes nach:
          <em>
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          (&quot;Plugins&quot;) des sozialen Netzwerkes facebook.com, welches
          ...
          oder einen Kommentar abgibt, wird die entsprechende Information von
          ...
          Verarbeitung und Nutzung der Daten durch Facebook sowie diesbezügliche
          Rechte und Einstellungsmöglichkeiten des Kunden zum Schutz seiner
          Privatsphäre ist den Datenschutzhinweisen von Facebook zu entnehmen.
          Sollte der Kunde nicht wollen, dass Facebook in der vorbeschriebenen
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          interagieren, zum Beispiel den &quot;Instagram&quot;-Button betätigen,
          ...
          Verarbeitung und Nutzung der Daten durch Instagram sowie Ihre
          diesbezüglichen Rechte und Einstellungsmöglichkeiten zum Schutz Ihrer
          Privatsphäre entnehmen Sie bitte den Datenschutzhinweisen von
          Instagram:
          <a
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          YouTube wird vertreten durch Google Inc. mit Sitz in 1600 Amphitheatre
          Parkway, Mountain View, CA 94043, USA. Die verantwortliche Stelle
          verwendet auf ihrer Website Plugins des Anbieters YouTube. Wenn Sie
          unsere mit einem YouTube Plugin versehene Internetpräsenz aufrufen,
          wird eine Verbindung zu den Servern von YouTube hergestellt. Hierdurch
          wird an den YouTube-Server übermittelt, welche Internetseiten Sie
          besucht haben. Sind Sie dabei als Mitglied bei YouTube eingeloggt,
          ordnet YouTube diese Information Ihrem persönlichen Benutzerkonto zu.
          Bei Nutzung des Plugins wie z.B. Anklicken des Start-Buttons eines
          ...
          der Nutzung unserer Internetseite aus ihrem YouTube-Benutzerkonto
          sowie anderen Benutzerkonten der Firmen YouTube LLC und Google Inc.
          abmelden und die entsprechenden Cookies der Firmen löschen. Weitere
          Informationen zur Datenverarbeitung und Hinweise zum Datenschutz durch
          YouTube (Google) finden Sie unter
          <a
        ...
        <p className="mb-8  text-justify lg:mb-16 text-gray-500 dark:text-gray-400 sm:text-l">
          ...
          können Sie Auskünfte, Löschungs- und Berichtigungswünsche zu Ihren
          Daten und gerne auch Anregungen jederzeit per Brief oder E-Mail an die
          Adresse unten im Impressum senden.
        </p>
