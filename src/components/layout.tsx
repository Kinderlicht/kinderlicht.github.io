    ...
    <footer className="bg-white dark:bg-gray-900">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <p className="text-sm text-gray-500">Created with ❤️ by <a href="https://de.linkedin.com/in/matthias-kettl-42a300213">Matthias Kettl</a> and <a href="https://fschoenberger.dev">Frederic Schönberger</a></p>
