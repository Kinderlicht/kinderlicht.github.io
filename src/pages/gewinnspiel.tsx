...
export default function Home() {
 ...
 <div className="p-4 container max-w-6xl mx-auto space-y-6 sm:space-y-12 mb-10 mt-32">
    <h2 className="mb-16 text-3xl font-bold text-center">Teilnahmebedingungen Kinderlicht Wallersdorf e. V. - Social Media Gewinnspiel</h2> 
<p>Das Gewinnspiel wird von Kinderlicht Wallersdorf e. V. veranstaltet. Teilnahmeberechtigt ist jede natürliche Person mit Wohnsitz in Deutschland, die das 18. Lebensjahr vollendet hat. Das Gewinnspiel beginnt am 22.11.2025; Teilnahmeschluss des Gewinnspiels ist der 21.12.2025 um 23:59 Uhr. Verspätete Teilnahmen können nicht berücksichtigt werden.</p> 
...
<h2 className="text-2xl font-extrabold dark:text-white">Benachrichtigung der Gewinner</h2> 
<p>Die Gewinner werden im Anschluss an das Gewinnspiel direkt auf den jeweiligen Plattformen (Facebook und Instagram) benachrichtigt. Dies erfolgt über eine Antwort auf den ursprünglichen Kommentar, durch den an dem Gewinnspiel teilgenommen wurde, sowie gegebenenfalls per Direktnachricht. In der Benachrichtigung werden die Gewinner aufgefordert, am 22.12.2025 zwischen 18:00 und 21:00 Uhr am Weihnachtstand des Kinderlicht Wallersdorf e. V. zu erscheinen, um den Gewinn einzulösen. Sollte sich ein Gewinner bis zum 22.12.2025 um 21:00 Uhr nicht eigenständig am Weihnachtstand melden, verfällt der Gewinn. Die Bekanntgabe der Gewinner erfolgt ohne Gewähr.</p> 

<h2 className="text-2xl font-extrabold dark:text-white">Datenschutz</h2> 
...
<h2 className="text-2xl font-extrabold dark:text-white">Vorzeitige Beendigung des Gewinnspiels</h2> 
...
<h2 className="text-2xl font-extrabold dark:text-white">Anwendbares Recht; Salvatorische Klausel; Ausschluss des Rechtswegs; Änderungsrecht</h2> 
...
<h2 className="text-2xl font-extrabold dark:text-white">Keine Beteiligung von Facebook oder Instagram</h2> 
...
<h2 className="text-2xl font-extrabold dark:text-white">Impressum des Gewinnspielveranstalters</h2> 
