...
<h2 className="text-4xl font-extrabold dark:text-white">Gewinnbeschreibung</h2>
...
<h2 className="text-4xl font-extrabold dark:text-white">Benachrichtigung der Gewinner</h2> 
...
<h2 className="text-4xl font-extrabold dark:text-white">Datenschutz</h2> 
...
<h2 className="text-4xl font-extrabold dark:text-white">Vorzeitige Beendigung des Gewinnspiels</h2> 
...
<h2 className="text-4xl font-extrabold dark:text-white">Anwendbares Recht; Salvatorische Klausel; Ausschluss des Rechtswegs; Änderungsrecht</h2> 
...
<h2 className="text-4xl font-extrabold dark:text-white">Keine Beteiligung von Facebook oder Instagram</h2> 
...
<h2 className="text-4xl font-extrabold dark:text-white">Impressum des Gewinnspielveranstalters</h2> 
